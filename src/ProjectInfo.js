...
export const projects = {
    bugTrackerApp: {
        ...
        description:  "This Bug Tracker App helps developers keep track of bugs/problems in their projects.Users can: Login and register, add or delete comments and projects, or update user info. This app utilizes relational databases, rest api's, crud operations, user login and register forms and user authentication. Built with React.js, Javascript, CSS, Express.js, express passport, bcrypt, cors, express validator, redux and axios."
    },
    weatherApp: {
        name: "weatherApp",
        imgUrl: require('./images/weather-app2.jpg'),
        url: "https://personal-weather-app.com",
        description: "This Weather app allows users to type in a city and get the weather in real time. Equiped with weather changing background based on weather conditions. Built with React.js, Javascript, CSS, openweathermap.com api."
    },
    rolexApp: {
        name: "rolexApp",
        imgUrl: require('./images/rolex-thumbnail.jpg'),
        url: "https://seans-rolex-watches.netlify.app",
        description: "This is a imitation Rolex website. Complete, with soft fonts, raised images, perfect margins, soft colors and smooth transitions. Users can browse watches and choose from diffent styles, add items to the shopping cart and checkout using Stripe-Checkout payment system. Built with React.js, CSS, Local Storage and utilizes the Stripe-Checkout api."
    ...
    tetrisApp: {
        ...
        description: "If you dont know this game then you are crazy! Tetris has been around for about 30 years, and people all over the world still love this timeless classic! Built using HTML5, CSS5 and JavaScript. This app utilizes algorithms and functional programming."
    },
    sudokuApp: {
        name: "sudokuApp",
